...
A random forest classifier \cite{breiman2001random} was used for this analysis. The classifier developed using the training set was evaluated on the validation set. For this analysis, a recall of $0.98$ was chosen as the acceptable level of recall. This was the highest level of recall observed in the validation dataset before we run into the situation of screening everyone. We hope to catch $98\%$ of the bad loans. The threshold for this level of recall was used to evaluate the model on the test set.
